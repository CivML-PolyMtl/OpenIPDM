...
QTrue= paramTrue.^2*[(dt^5)/20 (dt^4)/8 (dt^3)/6;(dt^4)/8 (dt^3)/3 (dt^2)/2;(dt^3)/6 (dt^2)/2 dt];
C=[1,0,0]; 
...
[loglik,MAcc,AccVal,AccST,PWithinCI,PWithinCITrue,Ebar,Ebarbar,...
    ...
    Erbias, Erbarbias, AccValBias]=KFsKF([],y, A, C, Q, R, Re,init_x, init_V,InpecBiase,OptmInsp,RU,...
