function [sd, mu_v] = OnlineInference_short(Data_inspect, Inspectorlabel, init_x, init_V, A, Q, UpdatedInspectorsData,PARAM, init_estim,MdataEngy)
...
%save_mu(1,:) = mu_v0 * ones(I,1); %mu_v1

save_mu(1,:) = (UpdatedInspectorsData{1, 1}(:,2))'; %mu_v1
% save_mu(1,:) = 0 ;
save_cov(4,4,:) = mu_sd_V0^2;  %sig_v1
%save_cov = load('C:\Users\BL\Documents\PARAM\synt_OI_1epoch\save_cov.mat');
