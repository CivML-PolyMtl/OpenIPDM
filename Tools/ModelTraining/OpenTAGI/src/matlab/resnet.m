...
classdef resnet
    methods (Static)
        function [layer, filter, kernelSize, padding, paddingType, stride, nodes, actFunIdx, xsc] = debug(imgSize, ny, numBlock)
            % Input
            layer0          = [2                2       6];
            filter0         = [imgSize(3)       4       4];
            kernelSize0     = [3                1       3];
            padding0        = [1                0       1];
            paddingType0    = [1                0       1];
            stride0         = [1                0       1];
        ...
        function [layer, filter, kernelSize, padding, paddingType, stride, nodes, actFunIdx, xsc] = imagenet18_V2(imgSize, ny, numBlock)
            % Input
            layer0          = [2                2       6       3       2      6    3];
            filter0         = [imgSize(3)       16      16      16      32     32   32];
            kernelSize0     = [11               1       3       3       1      3    3];
            padding0        = [3                0       1       1       0      1    1];
            paddingType0    = [1                0       2       1       0      2    1];
            stride0         = [2                0       2       1       0      0    0];
            nodes0          = [prod(imgSize)    0       0       0       0      0    0];
            actFunIdx0      = [0                4       0       0       0      0    0];
            connect0        = [0                0       0       0       0      0    0];
            xsc0            = [0                0       0       0       0      0    1];
            % Stage 1
            layer1          = [2    6   2   6];
            filter1         = [64   64  64  64];
        ...
        function [layer, filter, kernelSize, padding, paddingType, stride, nodes, actFunIdx, xsc] = imagenet18(imgSize, ny, numBlock)
            % Input
            layer0          = [2                2       3];
            filter0         = [imgSize(3)       64      64];
            kernelSize0     = [7                3       3];
            padding0        = [5                1       1];
            paddingType0    = [2                2       1];
            stride0         = [2                2       1];
            ...
            % Satge 4
            layer4          = [2    6   2   6];
            filter4         = [512  512 512 512];
            kernelSize4     = [1    3   1   3];
            padding4        = [0    1   0   1];
            paddingType4    = [0    1   0   1];
            stride4         = [0    1   0   1];
            actFunIdx4      = [4    0   4   0];
            numBlocks4      = numBlock;
            tpadding4       = 0;
            ...
            tstride4        = 1;
            tkernel4        = 7;
            [layer4, filter4, kernelSize4, padding4, paddingType4, stride4, nodes4, actFunIdx4, connect4, xsc4] = resnet.block(layer4, filter4, kernelSize4, padding4, paddingType4, stride4, actFunIdx4, numBlocks4, tkernel4, tpadding4, tpaddingType4, tstride4);
            % Output
            layerL          = [4    1];
            filterL         = [512  1];
            kernelSizeL     = [1    1];
        ...
        function [layer, filter, kernelSize, padding, paddingType, stride, nodes, actFunIdx, xsc] = imagenet18_10classes(imgSize, ny, numBlock)
            % Input
            layer0          = [2                2       6];
            filter0         = [imgSize(3)       64      64];
            kernelSize0     = [3                1       3];
        ...
        function [layer, filter, kernelSize, padding, paddingType, stride, nodes, actFunIdx, xsc] = tinyImagenetV1(imgSize, ny, numBlock)
            % Input
            layer0          = [2                2       6       4];
            filter0         = [imgSize(3)       16      16      16];
            kernelSize0     = [3                1       3       3];
            padding0        = [1                0       1       1];
            paddingType0    = [1                0       2       1];
            stride0         = [1                0       2       1];
            nodes0          = [prod(imgSize)    0       0       0];
            actFunIdx0      = [0                4       0       0];
            connect0        = [0                0       0       0];
            xsc0            = [0                0       0       1];
            % Stage 1
        ...
        function [layer, filter, kernelSize, padding, paddingType, stride, nodes, actFunIdx, xsc] = tinyImagenetV2(imgSize, ny, numBlock)
            % Input
            layer0          = [2                2       6];
