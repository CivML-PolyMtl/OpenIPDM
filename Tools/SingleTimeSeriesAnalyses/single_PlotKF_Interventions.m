...
% Add a patch
patch(app.UIAxes,[InterventionTime-1 InterventionTime InterventionTime InterventionTime-1],[25 25 100 100],1,'FaceColor','k','EdgeColor','none','FaceAlpha',0.2)
% The order of the "children" of the plot determines which one appears on top.
% I need to flip it here.set(gca,'children',flipud(get(gca,'children')))
